...
def create_template():
    ...
    header_row2 = [None, None, None, None, None, None,
    ...
    # 샘플 데이터 (23개 컬럼)
    sample_data = [
        ['도장', '신너(샘플)', '톨루엔', None, '108-88-3', 50, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None],
        ['도장', '신너(샘플)', '자일렌', None, '1330-20-7', 30, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None],
        ['세척', '세정제(샘플)', '아세톤', None, '67-64-1', 80, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None],
    ]
...
def create_template_excel():
    ...
    with pd.ExcelWriter(output, engine='openpyxl') as writer:
        ...
        # 열 너비 조정 (23개 컬럼)
        column_widths = [10, 20, 20, 12, 15, 10, 8, 8, 8, 12, 10, 10, 12, 10, 12, 12, 8, 12, 8, 8, 15, 15, 10]
